...
class Gardener:
    ...
    def knowledge_base():
        ...
        print("Садоводство — отрасль растениеводства, занимающаяся возделыванием многолетних плодовых или ягодных культур для получения фруктов, ягод и орехов; и выращиванием декоративных растений.")
...
gardener = Gardener("Дмитрий", bush)  # Садовник, ухаживающий за кустом
